...
def main():
    ...
    label_title_int = Label(main_tab, text="Trigometry IS FUN", font=("Consolas", 30, "bold"))

    button_table = Button(main_tab, text="Table", font=("Consolas", 15), command=table)
    button_question = Button(main_tab, text="Questions", font=("Consolas", 15), command=questions)
    button_formula = Button(main_tab, text="Formula", font=("Consolas", 15), command=formula)

    about_title_label = Label(about_tab, text="About", font=("Consolas", 30, "bold"))
    about_label = Label(about_tab, font=("Consolas", 10), text="""This was a school math project, made by:
    - Team Waccx
