...
class Shape(pygame.sprite.Sprite):
    ...
    _UPPER_CONTROL_RADIUS: int = 190
    _UPPER_LEFT_CONTROL_ANGLE: int = 153
    _UPPER_RIGHT_CONTROL_ANGLE: int = 27
    _LOWER_CONTROL_RADIUS: int = 84
    _LOWER_CONTROL_ANGLE: int = 270
    ...
    def __init__(self, image: pygame.Surface,
        ...
        self._moving = False
        self._rotation_controls = [RotationControl(pygame.transform.scale(shadow_image,(70,35)),
                                                 self.rect.center, Shape._UPPER_CONTROL_RADIUS,
                                                 Shape._UPPER_LEFT_CONTROL_ANGLE),
                                   RotationControl(pygame.transform.scale(shadow_image,(70,35)),
                                                 self.rect.center, Shape._UPPER_CONTROL_RADIUS,
                                                 Shape._UPPER_RIGHT_CONTROL_ANGLE),
                                   RotationControl(pygame.transform.scale(shadow_image,(70,35)),
                                                 self.rect.center, Shape._LOWER_CONTROL_RADIUS,
                                                 Shape._LOWER_CONTROL_ANGLE)]
        self._controls = pygame.sprite.Group(self._rotation_controls)
    ...
    def handle_mouse_motion(self, diff: tuple, mouse_loc: tuple) -> None:
        ...
        if self._moving:
            ...
            for control in self._rotation_controls:
